...
#peer chaincode upgrade -n fabinvoice -v 1.05 -o orderer.example.com:7050 -C mychannel -l "golang" -p "github.com/fabinvoice/go" -c '{"Args":[""]}' -P "OR ('Org1MSP.member','Org2MSP.member')"
